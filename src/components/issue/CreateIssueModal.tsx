...
export const CreateIssueModal = ({
  ...
  const [{}, formAction, pending] = useActionState(createIssueAction, {
    success: false,
    message: "",
  });
  ...
  function mustFindPropertyDefinition(id: string) {
    ...
    if (!propertyDefinition) {
      // 有些系统属性在业务上是保证一定存在的，若找不到，属于脏数据问题，非正常流程
                  ...
                  <div className="flex flex-grow">
                    ...
                    <div className="flex flex-grow pr-4 flex-col">
                      ...
                      <DescriptionField
                        ...
                        propertyDefinition={mustFindPropertyDefinition(
                          SystemPropertyId.DESCRIPTION,
                        )}
                  ...
                  <MinersField
                    ...
                    propertyDefinition={
                      propertyDefinitions.find(
                        (p) => p.id === SystemPropertyId.MINERS,
