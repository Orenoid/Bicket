...
import { FILTERABLE_PROPERTY_TYPES, PropertyType } from "@/lib/property/constants";
...
import { getAppliedFilterComponent, getFilterConstructorComponent } from "../property/registry-utils";
...
export default function FiltersToolBar({ propertyDefinitions }: FilterToolBarProps) {
